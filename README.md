...
<!-- Screenshots: put files in docs/images/ and reference them here with
     standard markdown image syntax. A capture script that regenerates them
     across light, dark, and mobile viewports lives in frontend/verification/. -->
...
docs/                           # engineering audits + incident notes
```
